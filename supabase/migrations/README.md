...
| `20260528230000_ovr30_template_progression_reason.sql` | OVR-30: `progression_reason_code` on template exercises |
| `20260529230000_ovr32_economy_game_events.sql` | OVR-32: `node_unlocked` event + `node` source type |
